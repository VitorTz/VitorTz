...
estudos não em aprender a usar game engines como Unity ou Godot mas sim em entender as soluções implementadas e propostas por tais e em quais fundamentos estes softwares estão sustentados.
 ...
 Estes projetos são uma versão simplificada do jogo [Geometry Dash](https://github.com/VitorTz/GeometryDash) e outra do jogo [Touhou](https://github.com/VitorTz/Touhou). Considero que ambos são satisfatórios e representam o conhecimento que adquiri até agora. Explicações mais detalhadas sobre cada um podem ser encontradas em seus respectivos repositórios.
